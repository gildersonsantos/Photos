...
class ProductImageAdapter(val activityContext: Context, val productImageList: MutableList<Bitmap>): RecyclerView.Adapter<ProductImageAdapter.ProductImageViewHolder>() {
